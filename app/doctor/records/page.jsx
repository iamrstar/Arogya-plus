...
import { FileText, Calendar, User, Search, Download, Loader2, Eye } from "lucide-react"
            ...
            setRecords([
                {
                    ...
                    type: "Clinical Note",
                    doctorName: user?.name || "Dr. Amit Patel",
                    date: "2024-03-12",
                    status: "signed",
                    fileSize: "0.8 MB",
                ...
                {
                    id: "REC002",
                    documentName: "Post-Surgery Recovery Report",
                    type: "Surgical Note",
                    doctorName: user?.name || "Dr. Amit Patel",
                    date: "2024-03-15",
                    status: "verified",
                    ...
                    patientId: "ADM011",
                    details: {
                        summary: "Patient is recovering well after knee surgery.",
                        vitals: {
                            bp: "118/76 mmHg",
                            hr: "68 bpm",
                            temp: "98.2 °F",
                        ...
                        findings: [
                            ...
                            "Mobility improving with physiotherapy."
                        ],
                        notes: "Continue current medication and physiotherapy schedule."
                    }
                }
            ])
            setLoading(false)
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">Access and manage patient clinical documents</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <div className="relative flex-1">
                        ...
                        <Input
                            placeholder="Search by patient name, document name or type..."
                            value={searchTerm}
                ...
                <div className="grid gap-4">
                    {filteredRecords.length === 0 ? (
                        ...
                        filteredRecords.map((r) => (
                            <Card key={r.id} className="hover:shadow-md transition-shadow rounded-2xl">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm font-medium text-slate-600">{r.type} • Patient: {r.patientName}</p>
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <Button size="sm" variant="ghost" className="h-10 w-10 p-0 hover:bg-slate-100 rounded-full" onClick={() => setSelectedRecord(r)}>
